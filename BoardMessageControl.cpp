...
void BoardMessageControl::InputMsg(struct Ddz * pDdz)
{
	...
	cout <<endl<< " 开始斗地主 （输入出牌请用空格隔开,只输入0为PASS,J Q K A 小王 大王分别为11 12 13 1 14 15,最后用0结束）" << endl<<endl;
 {
		...
		/*int us[21] = { 0,1,2,4,5,6,8,9,10, 20,22,50, 48, 49, 44, 45, 46, -1,-1,-1,-1};//我们的牌
		int latter[21] = {6, 2, 7, 41, 11, 16, 3, 46, 21, 17, 10, 52, 53, 47, 43, 19, 18,-1,-1,-1,-1 };//下家的牌
		int former[21] = { 30, 37, 13, 25, 22, 27, 8, 5, 48, 42, 36, 44, 45, 1, 40, 33, 51 ,-1,-1,-1,-1 };//上家的牌
		out[51] = 26;
		out[52] = 21;
		out[53] = 23; */
